...
<!--					<li><i class="iconfont">&#xe669;</i><a href="--><?//=$public_r['newsurl']?><!--e/gonggao/ListInfo.php?mid=10/">内部公告</a></li>-->
				...
				?>
                    <li><i class="iconfont">&#xe661;</i><a href="<?=$public_r['newsurl']?>e/ShopSys/address/ListAddress.php">我的账户</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/space/?userid=<?=$userid?>">我的主页</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/qianyue/ListInfo.php?mid=10">品牌签约</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/jieshao/ListInfo.php?mid=10">品牌介绍</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/chanpin/ListInfo.php?mid=10">产品中心</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/news/ListInfo.php?mid=10">公司动态</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/xiaoshou/ListInfo.php?mid=10">销售渠道</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/liuyan/ListInfo.php?mid=10">留言板</a></li>
                    <li><i class="iconfont">&#xe675;</i><a href="<?=$public_r['newsurl']?>e/pinpai/lianxi/ListInfo.php?mid=10">联系我们</a></li>
				<?
				}
				?>
	...
	<div class="singleRight">
		...
		<div class="login">
			...
			<div class="login_Hou">
				...
				<div class="uesrID"><?=$tmgetusername?>
                				<?php
                             	if($cked==1){
                                ?>          
