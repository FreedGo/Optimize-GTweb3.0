...
<div class="ui-tab-content">
        	<h3><span>信息列表 <a href="ListNews.php?bclassid=<?=$bclassid?>&classid=<?=$classid?>" title="已发布信息总数：<?=$classinfos?>" style=" margin-left:10px;" class="gl">已发布</a>
            <a href="ListNews.php?bclassid=<?=$bclassid?>&classid=<?=$classid?>&ecmscheck=1" title="待审核信息总数：<?=$classckinfos?>" class="gl">待审核</a>
            <a href="ListInfoDoc.php?bclassid=<?=$bclassid?>&classid=<?=$classid?><?=$addecmscheck?>" class="glon">归档</a></span></h3>
            <div class="line"></div>
           	<div class="saixuan">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td> <div align="left"  class="anniuqun"> 
              ...
              <input type=button name=button value=增加信息 onClick="self.location.href='AddNews.php?enews=AddNews&bclassid=<?=$bclassid?>&classid=<?=$classid?><?=$addecmscheck?>'">
                  &nbsp; 
...
<input type=hidden name=doing value=0>
  ...
  <div class="xwlistmenu">
  	<table>
<tr> 
            <td width="60%"><font color="#ffffff">[<a href="InfoDoc.php" target="_blank">批量归档信息</a>]&nbsp;[<a href=ReHtml/ChangeData.php target=_blank>更新数据</a>]&nbsp;[<a href=../../ target=_blank>预览首页</a>]&nbsp;[<a href="<?=$classurl?>" target=_blank>预览栏目</a>]</font> 
            </td>
          </tr>
        </table></div></td>
    </tr>
