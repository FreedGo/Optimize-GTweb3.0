...
<div class="wanzhanjiaoshiMsg">
    		...
    		<ul>
    			...
    			<li>
    				...
    				<select class="dataLeftShort" name="music_star" id="music_star">
                     <option value="维修达人"<?=$addr[music_star]=="维修达人"?' selected':''?>>维修达人</option> 
                     <option value="钢琴之星"<?=$addr[music_star]=="钢琴之星"?' selected':''?>>钢琴之星</option> 
                     <option value="提琴之星"<?=$addr[music_star]=="提琴之星"?' selected':''?>>提琴之星</option> 
                     <option value="吉他之星"<?=$addr[music_star]=="吉他之星"?' selected':''?>>吉他之星</option> 
                     <option value="琴行名人"<?=$addr[music_star]=="琴行名人"?' selected':''?>>琴行名人</option> 
                     <option value="管乐之星"<?=$addr[music_star]=="管乐之星"?' selected':''?>>管乐之星</option> 
                     <option value="民乐之星"<?=$addr[music_star]=="民乐之星"?' selected':''?>>民乐之星</option> 
                     <option value="歌唱之星"<?=$addr[music_star]=="歌唱之星"?' selected':''?>>歌唱之星</option> 
                     <option value="其它之星"<?=$addr[music_star]=="其它之星"?' selected':''?>>其它之星</option>   
    				</select>
    			</li>
    			<li>
