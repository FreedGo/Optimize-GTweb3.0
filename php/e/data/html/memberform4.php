...
?>        <link rel="stylesheet" type="text/css" href="/css/xin_base.css">     
    	...
    	<div class="wanzhanjiaoshiMsg">
    	  <ul><li>
    				<span class="dataLeft">身份证号：</span>
    				<input type="text" class="dataRight" name="shenfenzheng" required maxlength="18" placeholder="请输入您18位身份证号"  value="<?=$shenfenzheng?>">
    			</li>
   			  <li>
   				  <span class="dataLeft">性<?=$sex?>别：</span>
   			  ...
   			  <li>
   				  <span class="dataLeft">教学类型：</span>
   				  <select class="dataLeftShort" name="teacher_type" id="teacher_type">
                  		<option value="钢琴老师"<?=$teacher_type=="钢琴老师"?' selected':''?>>钢琴老师</option>
                        <option value="吉他老师"<?=$teacher_type=="吉他老师"?' selected':''?>>吉他老师</option>
                        <option value="弦乐老师"<?=$teacher_type=="弦乐老师"?' selected':''?>>弦乐老师</option>
                        <option value="管乐老师"<?=$teacher_type=="管乐老师"?' selected':''?>>管乐老师</option>
                        <option value="民乐老师"<?=$teacher_type=="民乐老师"?' selected':''?>>民乐老师</option>
                        <option value="电声老师"<?=$teacher_type=="电声老师"?' selected':''?>>电声老师</option>
   				  </select>
		    </li>
   			  <li>
   			  ...
   			  <li>
   				  <span class="dataLeft">毕业学校：</span>
   				  <input type="text" class="dataRight" name="biye" required placeholder="请输入您毕业的学校" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($addr[biye]))?>" >
   			  </li>
   			  <li>
...
<input id="sfdq_tj" type="hidden" name="address" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($addr[address]))?>"/>

<input id="csdq_tj" type="hidden" name="address1" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($addr[address1]))?>"/>

<input id="qydq_tj" type="hidden" name="address2" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($addr[address2]))?>"/>
			  ...
			  <li>
				  ...
				  <div class="video-upload">
						...
						//		onSelect: function(list) {alert('onSelect')}, /** 选择文件后的响应事件 */
								...
								onFileCountExceed: function(selected, limit) {alert('只能上传4张照片')}, /** 文件数量超出的响应事件 */
