        ...
        <form class="haixuanbaoming haixuanbaoming1 videobaoming" name="add" method="POST" enctype="multipart/form-data" action="/e/DoInfo/ecms.php" onSubmit="return EmpireCMSQInfoPostFun(document.add,'20');">
              ...
              <ul>
                 ...
                 <table class="baomingMsgTable" width=100% align=center cellpadding=3 cellspacing=1 bgcolor=#DBEAF5>
                    ...
                    <tr>
                        <td width='16%' height=25 bgcolor='ffffff'>品牌视频:</td>
                        <td bgcolor='ffffff'>
                    ...
                    <tr>
                        <td width='16%' height=25 bgcolor='ffffff'>品牌简介:</td>
          ...
          <ul>
            ...
            <table class="baomingMsgTable" width=100% align=center cellpadding=3 cellspacing=1 bgcolor=#DBEAF5>
                ...
                <tr>
                    ...
                    <td bgcolor='ffffff'>
                   <input class="pinpai-baoming-select" name="pintype[]" type="checkbox" value="钢琴">钢琴
                ...
                <tr >
                    ...
                    <td bgcolor='ffffff' class="clearfix">
                        ...
                        <input class="tlePicVal" type="hidden">
                    </td>
                </tr>
            </table>
                ...
                <script type="text/javascript">
                    ...
                    window.onload=function(){
                        ...
                        xiuxiu.embedSWF("altContent",5,"700","500","altContent");
                        //修改为您自己的图片上传接口
                        xiuxiu.setUploadURL("http://www.greattone.net/test/image_upload_form.php");
