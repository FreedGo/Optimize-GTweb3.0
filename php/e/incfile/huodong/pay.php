...
$empire=new mysqlquery(); //声明数据库操作类</p> <p>db_close(); //关闭MYSQL链接 
	...
	$o=$empire->fetch1("select money_type from phome_ecms_shop where id='$did'"); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="rightWrap clearfix">
      ...
      <?php
        ...
        <ul>
              ...
              <ol class="clearfix">
                <li>
                  <label for="ofubao" class="twpay">
                    <input name="pay_way_select" type="radio" class="payWay payWay4" id="ofubao" checked>
          ...
          <li class="clearfix">
            <span class="payLeft">支付金额：</span><span class="payRight1"><?=$r[money]?>新台币</span>
          </li>
          <li><input class="goPay" id="payBtn" type="submit" value="去支付"></li>
        </ul>
        </form>
