              ...
              <ul>
                ...
                <table class="baomingMsgTable" width=100% align=center cellpadding=3 cellspacing=1 bgcolor=#DBEAF5>
                  <tr>
                    <td width='16%' height=25 bgcolor='ffffff'>选手姓名：</td>
                    <td bgcolor='ffffff'>
                      <input name="hai_name" type="text" id="hai_name" value="" size="" required>                    </td>
                  </tr>
                  <tr>
                    <td width='16%' height=25 bgcolor='ffffff'>联系电话:</td>
                    <td bgcolor='ffffff'>
                      <input name="hai_phone" type="text" id="hai_phone" value="" size="" required>                    </td>
                  </tr>
                  ...
                  <tr>
                    <td width='16%' height=25 bgcolor='ffffff'>详细地址:</td>
                    <td bgcolor='ffffff'>
                      <input name="hai_address" type="text" id="hai_address" value="" size="" required>                    </td>
                  </tr>
                  <tr>
                    <td width='16%' height=25 bgcolor='ffffff'>年龄:</td>
                    <td bgcolor='ffffff'>
                      <input name="hai_age" type="text" id="hai_age" value="" size="" required>                    </td>
                  </tr>
                <!--  <tr>
                    <td width='16%' height=25 bgcolor='ffffff'>所推荐的琴行(老师):</td>
                    <td bgcolor='ffffff'>
...
?>
		<div class="baomingSelect clearfix" >
          <div class="baomingchange change1 on f-l-l">上传图片报名</div>
          <div class="baomingchange change2  f-l-l">上传视频报名</div>
          
        </div>
        <!--图片报名开始····················································-->
      <form name="add" class="haixuanbaoming1 imgbaoming jingling-img" method="POST" enctype="multipart/form-data" action="/e/DoInfo/ecms.php" onSubmit="return EmpireCMSQInfoPostFun(document.add,'35');">
          <input type=hidden value=MAddInfo name=enews><input type=hidden value=104 name=classid>
          <input name=id type=hidden id="id" value=>
          <input name=mid type=hidden id="mid" value=35>
          <input name="bao_type" type="hidden" value="3">
    ...
    <!--图片报名结束·1········································································-->
        <!--视频报名········································jingling-vide是为了调换图片和视频的顺序 ··············--> 
        <form class="haixuanbaoming haixuanbaoming1 videobaoming jingling-video" name="add" method="POST" enctype="multipart/form-data" action="/e/DoInfo/ecms.php" onSubmit="return EmpireCMSQInfoPostFun(document.add,'20');">
        <input type=hidden value=MAddInfo name=enews> <input type=hidden value=73 name=classid>
        <input name=id type=hidden id="id" value=>
        <input name=bao_type type=hidden id="id" value="3">
        <input type="hidden" name="dingdan" value="<?=$ddid?>" />
