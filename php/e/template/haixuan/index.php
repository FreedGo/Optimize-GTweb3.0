...
<div class="bodyWrap clearfix">
  ...
  <div class="rightWrap clearfix">
      ...
      <div class="baomingMsg baomingMsg2">
        ...
        if($r[hai_baotype]=="|视频|"){
        ?>
        <form class="haixuanbaoming haixuanbaoming1 videobaoming" style="display: block" name="add" method="POST" enctype="multipart/form-data" action="/e/DoInfo/ecms.php" onSubmit="return EmpireCMSQInfoPostFun(document.add,'20');">
