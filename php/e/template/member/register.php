                ...
                <td height="25" colspan="2" bgcolor="#FFFFFF">
                    <table width='100%' align='center' cellpadding=3 cellspacing=0 bgcolor='#DBEAF5'>
                        ...
                        <td width='75%' bgcolor='ffffff' class="chongfumima">
                            ...
                            <input name='phone' type='text' id='photo' style="float:left;" class="iphoneNum" phone="t"
                        ...
                        <tr>
                            ...
                            <td bgcolor='ffffff'>
                                ...
                                <input class="yanzheng-pre newYanZhengBtn" type="button" value="获取验证码"/></td>
                        </tr>
                        <?
                        if ($groupid != 5) {
                            ?>
            ...
            <tr>
                ...
                <td>
                    <label class="user_agree_wrap" for="user_agreement">
                        <input class="user_agree" id="user_agreement" type="checkbox" checked>我已经认真阅读<a href="">《网站会员注册协议》</a>，
                        并完全同意所有条款。
                    </label>
                </td>
            </tr>
