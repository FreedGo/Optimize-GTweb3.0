...
<div class="hy_nav">
            	<ul>
            		<li><a href="/e/member/msg/" class="selected">我的消息</a><a href="/e/member/msg/"></a></li>
            		<li><a href="/e/member/msg/AddMsg/?enews=AddMsg">发送消息</a><a href="/e/member/msg/AddMsg/?enews=AddMsg" class="selected"></a></li>
            	</ul>
</div>
<div class="setting yh">
   <form action="../../doaction.php" method="post" name="sendmsg" id="sendmsg">
   		<input type="hidden" name="zzxx" value="532088631"/>
            	<ul>
                    <li><label>标题</label><input name="title" type="text" value="<?=ehtmlspecialchars(stripSlashes($title))?>" class="input_text w180"></li>
