			...
			<div class="footNavWrap clearfix">
				<div class="footNav clearfix">
					<dl>
						...
						<dt><a href="[!--news.url--]guangchang">推荐帖</a></dt>
						<dt><a href="[!--news.url--]guangchang/guang">全站动态</a></dt>
						<dt><a href="[!--news.url--]news/huodong">音乐活动</a></dt>
						<dt><a href="[!--news.url--]e/zhiyin/ListInfo.php?mid=10">知音动态</a></dt>
					</dl>
					<dl>
					...
					<dl>
						...
						<dt><a href="[!--news.url--]haixuan">音乐精灵</a></dt>
					...
					<dl>
						...
						<dt><a href="[!--news.url--]laoshi">钢琴老师</a></dt>
...
<!--						<p class="zhanzhang"><script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1256607007'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1256607007%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script></p>-->
					...
					<div class="footcon">
						...
						<p>地址：新竹市四維路80號  電話：03-528-5680 E-mail：chengyun0423@franzsandner.com</p>
					</div>
				</div>
			</div>
		</div>
...
<script>
	...
	(function() {
		...
		hm.src = "//hm.baidu.com/hm.js?9e04abd1caf883d74ef53e2e445ddfe5";
