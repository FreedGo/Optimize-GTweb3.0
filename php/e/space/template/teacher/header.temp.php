...
<head>
	...
	<title><?= $username ?>老师的主页</title>
	<meta name="keywords" content="<?= $spacename ?>"/>
	<meta name="description" content="<?= $username ?>老师的主页"/>
	...
	<script type="text/javascript">
		jQuery(document).ready(
			function () {
				...
				var a = jQuery;
				a("#feedlist .lightbox").mouseenter(function () {
...
<div class="loginQian">
	...
	<form name=login method=post action="/e/member/doaction.php">
		...
		<ul>
			...
			<li class="loginSub"><input type="submit" id="submit" name="Submit" value=""><label for="submit">登　录</label>
			</li>
		</ul>
	</form>
	<div class="register">
