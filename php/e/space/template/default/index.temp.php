...
?>
		...
		<div class="bd">
				...
				<ul class="quanzhandongtai pubu1">
					...
					<!-- 分享的js代码结束 -->
<?
$sql=$empire->query("select * from {$dbtbpre}ecms_photo a left join {$dbtbpre}enewsmemberadd b on a.userid=b.userid left join {$dbtbpre}enewsmember c on a.userid=c.userid where a.userid='$userid' and classid in(11,12,13) order by a.id  desc limit 20" );
