...
// 主要修正了chrome浏览器的兼容性，在IE9以上，火狐，chrome亲自测试都有效，可以正常记忆当前选择并且刷新或者
// 重新打开网页之后保持不变
// 增加用html5本地存储来标记简繁状态，cookies同样有效

// -------------- 以下参数大部分可以更改 --------------------
//s = simplified 简体中文 t = traditional 繁体中文 n = normal 正常显示
var zh_default = 'n'; //默认语言，请不要改变
var zh_choose; //当前选择
	zh_choose=localStorage.getItem('zh_choose');
...
$('.jianti').click(function(event) {
	localStorage.setItem("zh_choose","s");
	$(this).hide();
	$('.fanti1').show();
});

$('.fanti1').click(function(event) {
