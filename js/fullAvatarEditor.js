function fullAvatarEditor() {
	...
	var file			= '/e/templeta/member/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '/e/templeta/member/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 530;							//flash文件的宽度
